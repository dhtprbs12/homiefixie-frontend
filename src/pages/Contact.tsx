          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              ...
              <p className="text-gray-600 mb-8">
                Have questions about HomieFixie? Need help with a specific project? We're here to help! 
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@homiefixie.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">FAQ & Help</h3>
                    <p className="text-gray-600">Check our help center for quick answers</p>
                    <p className="text-sm text-gray-500 mt-1">Common questions and troubleshooting guides</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Help us make HomieFixie even better</p>
                  </div>
                </div>
              </div>
            </div>
